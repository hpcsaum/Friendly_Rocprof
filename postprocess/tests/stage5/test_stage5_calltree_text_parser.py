...
parser = load_module_by_path("stage5_calltree_text_parser", "stage5", "stage5_calltree_text_parser.py")
...
class FlatRowsFromCalltreeTextTests(unittest.TestCase):
    def test_parses_a_simple_tree_with_correct_parent_links(self):
        ...
        jacobi_sweep = make_label_parent_row("jacobi_sweep", parent=main)
        jacobi_kernel = make_label_parent_row("jacobi_kernel.kd", parent=jacobi_sweep)
        mpi_barrier = make_label_parent_row("MPI_Barrier", parent=main)
    ...
    def test_hard_wrapped_label_is_reconstructed_exactly(self):
        ...
        main = make_label_parent_row("main")
        kernel = make_label_parent_row(long_label, parent=main)
    ...
    def test_multiple_roots_each_get_parent_none(self):
        main = make_label_parent_row("main")
        foo = make_label_parent_row("foo", parent=main)
        other_root = make_label_parent_row("other_root")
        bar = make_label_parent_row("bar", parent=other_root)
    ...
    def test_hidden_nodes_marker_line_is_skipped_not_merged_as_a_continuation(self):
        main = make_label_parent_row("main")
        foo = make_label_parent_row("foo", parent=main)
        baz = make_label_parent_row("baz", parent=foo)
